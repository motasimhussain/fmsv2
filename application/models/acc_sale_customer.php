...
class Acc_sale_customer extends CI_Model {
	...
	// 		$query = "SELECT SUM(tot_amnt) AS bal FROM sales WHERE cmp_name = '".$this->input->post('coname')."' AND date < '".$date_1."' ORDER BY date DESC LIMIT 1";
...
/* End of file acc_sale_customer.php */
/* Location: ./application/models/acc_sale_customer.php */