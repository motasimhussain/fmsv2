                    ...
                    <div class="row">
                        ...
                        <!-- general form elements disabled -->
                            <div class="box box-warning">
                                ...
                                <div class="box-body">
                                    <form class="form-horizontal" action="<?php echo base_url(); ?>index.php/form_process/bank_trans" method="post">
                                      <fieldset>

                                        <div class="form-group">
                                        <label class="col-md-4 control-label" for="b_id">Workplace:</label>
                                        <div class="col-md-4">
                                       ...
                                       <div class="form-group">
                                        <label class="col-md-4 control-label" for="c_id">Company:</label>
                                        <div class="col-md-4">
