...
<aside class="right-side">
    ...
    <section class="content-header">
        <ul class="list-inline">
            <li><h3 style="margin-top: 0px;margin-bottom: 0px;">Add Payment Voucher</h3></li>
            <li class="pull-right"><a class="btn btn-success" href="<?php echo base_url(); ?>index.php/site/payment_list"><span class="fa fa-print"></span> Print Voucher</a></li>
        </ul>
    </section>
        ...
        <div class="row">
            ...
            <!-- general form elements disabled -->
                <div class="box box-warning">
                    ...
                    <div class="box-body">
                        <form action="<?php echo base_url(); ?>index.php/form_process/add_pv" method="post" class="form-horizontal">
                          <fieldset>
                            ...
                            <!-- Text input-->
                            <div class="form-group">
                              <label class="col-md-4 control-label" for="b_address">Payment Mode</label>  
                              <div class="col-md-4">
