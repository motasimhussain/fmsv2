                        ...
                        <div class="col-xs-12">
                            ...
                            <div class="box">
                                <div class="box-header">
                                    <h3 class="box-title">List of all Payment Vouchers</h3>                                    
                                </div><!-- /.box-header -->
                                        ...
                                        <?php if(isset($list)): ?>
                                            <?php foreach ($list as $row):?>
                                                <tr>
                                                    ...
                                                    <td class="text-center"><a href="<?php echo base_url(); ?>index.php/site/payment_list/<?php echo $row->id?>/print" class="fa fa-print"></a></td>
                                                    <td class="text-center"><a href="<?php echo base_url(); ?>index.php/site/payment_list/<?php echo $row->id?>/edit" class="glyphicon glyphicon-pencil"></a></td>
                                                    <td class="text-center"><a href="<?php echo base_url(); ?>index.php/site/payment_list/<?php echo $row->id?>/delete" class="glyphicon glyphicon-remove"></a></td>
                                                </tr>
                                            <?php endforeach; ?>
                                        <?php endif; ?>
                                        </tbody>
