<aside class="right-side">
    ...
    <section class="content-header">
        <form class="form-inline" method="post" action="<?php echo base_url(); ?>index.php/site/acc_purchase_gst">
           ...
           <table class="MsoTableGrid table" border=0 cellspacing=0 cellpadding=0
            ...
            <table class="MsoTableGrid table" border=1 cellspacing=0 cellpadding=0
             ...
             <tr>
              ...
              normal'><?php echo number_format(abs($row->sales_tax_tot),2); ?></p>
              </td>
              ...
              <?php 
                  $temp += $row->sales_tax_tot;
                  $deb += $row->sales_tax_tot;
               ?>
