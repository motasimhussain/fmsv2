                    ...
                    <div class="row">
                        ...
                        <!-- general form elements disabled -->
                            <div class="box box-warning">
                                ...
                                <div class="box-body">
                                    <form class="form-horizontal" action="<?php echo base_url(); ?>index.php/form_process/acc_sale_op_bal" method="post">
                                      <fieldset>
                                     ...
                                     <div class="form-group">
                                        ...
                                        <div class="col-md-4">
                                          ...
                                          <a href="<?php echo base_url()?>index.php/site/all_op_bal" class="btn btn-success pull-right">Edit</a>
                                        </div>
                                      </div>
                                      </div>
