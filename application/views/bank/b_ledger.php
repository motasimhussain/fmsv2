<aside class="right-side">
    ...
    <section class="content-header">
        <form class="form-inline" method="post" action="<?php echo base_url(); ?>index.php/site/b_ledger">
          ...
          <ul class="list-inline">
            ...
            <li><label class="control-label" for="b_id">Pick Bank</label> </li>
            <li> 
              <select id="b_id" name="b_id" class="form-control" style="width:10em;">
       ...
       <div style="padding-right:5px;padding-left:5px;">
           ...
           <table class="MsoTableGrid table" border=0 cellspacing=0 cellpadding=0
             ...
             <tr>
              ...
              normal'><?php echo $this->session->userdata('bank'); ?></p>
              </td>
            ...
            <table class="MsoTableGrid table" border=1 cellspacing=0 cellpadding=0
             ...
             <tr>
              ...
              normal'><?php echo number_format(abs($row->amnt),2); ?></p>
              </td>
              <?php 
                  $temp -= $row->amnt;
                  $cred += $row->amnt;
           ...
           <?php endforeach; ?>
             <tr>
              ...
              normal'><?php echo number_format($deb,2) ?></p>
              </td>
