...
<aside class="right-side">
    ...
    <section class="content-header">
        <form class="form-inline" method="post" action="<?php echo base_url(); ?>index.php/site/purchase_list">
            ...
            <!-- general form elements  -->
                <div class="">
                    <div class="box-header">
                        ...
                        ?>
                        <h3 class="box-title pull-right goup" style="display:block-inline; padding-right:30px; margin-top:10px;">Purchase <small><?php echo $mysqldate; ?></small></h3>
                    </div><!-- /.box-header -->
                    <div class="box-body">
