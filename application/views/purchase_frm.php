            ...
            <div class="box box-warning">
                <div class="box-header">
                    ...
                    <div class="box-body">
                        ...
                        <form class="form-horizontal" method="post" action="<?php echo base_url(); ?>index.php/form_process/purchase_frm">
                            <fieldset>
                                <!-- Form Name -->
                                <!-- Select Basic -->
                                ...
                                <?php
                                    ...
                                    <!-- Select Basic -->
                                    <div class="form-group">
                                        <label class="col-md-4 control-label" for="cmp_name">Supplier:</label>
                                        <div class="col-md-7">
                            ...
                            <div class="box">
                                <div class="box-header">
                                    ...
                                    <div class="box-body table-responsive">
                                        ...
                                        <br>
                                        <form method="post" action="<?php echo base_url(); ?>index.php/site/gen_purchase_inv">
